  ...
  return (
    ...
    >
      <nav
        ...
        className="mx-auto max-w-4xl rounded-full bg-cream px-6 py-5 border-2 border-ink-black shadow-[3px_3px_0px_0px_rgba(26,26,26,1)] transition-transform duration-300 hover:scale-[1.01]"
      >
